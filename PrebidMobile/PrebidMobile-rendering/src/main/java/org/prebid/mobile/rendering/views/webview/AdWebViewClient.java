...
public class AdWebViewClient extends WebViewClient {
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
        if (view == null) {
            PbLog.error(TAG, "onPageStarted failed, WebView is null");
            return;
        }
        ...
        try {
            ...
            PbLog.error(TAG, "onPageStarted failed for url: " + url + " : " + Log.getStackTraceString(e));
        }
    }
    ...
    public void onPageFinished(WebView view, String url) {
        if (view == null) {
            PbLog.error(TAG, "onPageFinished failed, WebView is null");
            return;
        }
        PbLog.debug(TAG, "onPageFinished: " + view);
        try {
            ...
            PbLog.error(TAG, "onPageFinished failed for url: " + url + " : " + Log.getStackTraceString(e));
        }
    }
    ...
    public void onLoadResource(WebView view, String url) {
        ...
        try {
            ...
            PbLog.error(TAG, "onLoadResource failed for url: " + url + " : " + Log.getStackTraceString(e));
        }
    }
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        PbLog.debug(TAG, "shouldOverrideUrlLoading, url: " + url);
        if (view == null) {
            PbLog.error(TAG, "onPageStarted failed, WebView is null");
            return false;
        }
        ...
        try {
            ...
            PbLog.error(TAG, "shouldOverrideUrlLoading failed for url: " + url + " : " + Log.getStackTraceString(e));
        }
        return true;
    }
