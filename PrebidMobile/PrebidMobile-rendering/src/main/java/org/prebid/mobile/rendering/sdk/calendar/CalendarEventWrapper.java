...
public final class CalendarEventWrapper
{
	...
	public void setStart(String start)
	{
		...
		{
            PbLog.error(TAG, "Failed to parse start date:" + e.getMessage());
		}
	}
	...
	public void setEnd(String end)
	{
		...
		{
            PbLog.error(TAG, "Failed to parse end date:" + e.getMessage());
		}
	}
	...
	public void setReminder(String reminder)
	{
		...
		{
            PbLog.error(TAG, "Failed to parse reminder date:" + e.getMessage());
		}
	}
	...
	private void setCalendarRecurrence(String recurrence)
	{
		if (recurrence != null && !recurrence.equals(""))
		{
			...
			{
                PbLog.error(TAG, "Failed to set calendar recurrence:" + e.getMessage());
			}
		}
	}
