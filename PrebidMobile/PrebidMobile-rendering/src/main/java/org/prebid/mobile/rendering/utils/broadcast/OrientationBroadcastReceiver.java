...
public class OrientationBroadcastReceiver extends BroadcastReceiver {
    ...
    public boolean isOrientationChanged() {
        PbLog.debug(TAG, "isOrientationChanged: " + orientationChanged);
        return orientationChanged;
    }

    public void setOrientationChanged(boolean orientationChanged) {
        PbLog.debug(TAG, "setOrientationChanged: " + orientationChanged);
        this.orientationChanged = orientationChanged;
    }

    public void handleOrientationChange(int currentRotation){
        PbLog.debug(TAG, "handleOrientationChange currentRotation = " + currentRotation);
    }
