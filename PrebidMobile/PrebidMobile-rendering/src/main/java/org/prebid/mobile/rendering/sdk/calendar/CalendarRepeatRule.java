...
public final class CalendarRepeatRule {
    ...
    public void setExpires(String expires) {
        try {
            ...
            PbLog.error(TAG, "Failed to parse expires date:" + e.getMessage());
        }
    }
        ...
        if (exceptionDates != null) {
            ...
            for (String dateTimeString : exceptionDates) {
                try {
                    ...
                    PbLog.error(TAG, "Failed to parse exception date:" + e.getMessage());
                }
                ++ind;
            }
        }
    ...
    private void setMonthsInYear(JSONArray monthsInYear) {
        if (monthsInYear != null) {
            try {
                ...
                PbLog.error(TAG, "Failed to set months in year:" + e.getMessage());
            }
        }
    }
    ...
    private void setWeeksInMonth(JSONArray weeksInMonth) {
        if (weeksInMonth != null) {
            try {
                ...
                PbLog.error(TAG, "Failed to set weeks in month:" + e.getMessage());
            }
        }
    }
    ...
    private void setDaysInYear(JSONArray daysInYear) {
        if (daysInYear != null) {
            try {
                ...
                PbLog.error(TAG, "Failed to set days in year:" + e.getMessage());
            }
        }
    }
    ...
    private void setDaysInMonth(JSONArray daysInMonth) {
        if (daysInMonth != null) {
            try {
                ...
                PbLog.error(TAG, "Failed to set days in month:" + e.getMessage());
            }
        }
    }
    ...
    private void setDaysInWeek(JSONArray daysInWeek) {
        if (daysInWeek != null) {
            try {
                ...
                PbLog.error(TAG, "Failed to set days in week:" + e.getMessage());
            }
        }
    }
    ...
    private void setExceptionDates(JSONArray exceptionDates) {
        if (exceptionDates != null) {
            try {
                ...
                PbLog.error(TAG, "Failed to set exception days:" + e.getMessage());
            }
        }
    }
    ...
    private void setInterval(String interval) {
        if (interval != null && !interval.equals("")) {
            try {
                ...
                PbLog.error(TAG, "Failed to set interval:" + e.getMessage());
            }
        }
    }
