...
public abstract class BaseAdView extends FrameLayout {
    ...
    public void setContentUrl(String contentUrl) {
        if (mAdViewManager == null) {
            PbLog.error(TAG, "setContentUrl: Failed. AdViewManager is null");
            return;
        }
    ...
    protected void handleBroadcastAction(String action) {
        PbLog.debug(TAG, "handleBroadcastAction: parent method executed. No default action handling. " + action);
    }
