...
public class AdViewProgressUpdateTask extends AsyncTask<Void, Long, Void> {
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
                ...
                if (System.currentTimeMillis() - mLastTime >= 50) {
                    if (!isCancelled()) {
                                ...
                                try {
                                    ...
                                    if (videoView != null) {
                                        ...
                                        if (mVastVideoDuration != -1 && newCurrent >= mVastVideoDuration) {
                                            PbLog.debug(VideoCreativeView.class.getName(), "VAST duration reached, video interrupted. VAST duration:" + mVastVideoDuration + " ms, Video duration: " + mDuration + " ms");
                                            videoView.forceStop();
                                        }
                                    ...
                                    PbLog.error(TAG, "Getting currentPosition from VideoCreativeView  failed: " + Log.getStackTraceString(e));
                                }
                            });
                        }
                        ...
                        try {
                            ...
                            PbLog.error(TAG, "Failed to publish video progress: " + Log.getStackTraceString(e));
                        }
                    }
            ...
            PbLog.error(TAG, "Failed to update video progress: " + Log.getStackTraceString(e));
        }
        return null;
    }
